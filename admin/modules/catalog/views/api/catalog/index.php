...
<div class="row">    
    <div class="col-md-3 col-sm-4">
        <div class="row">    
            <?
            $menu_items = $category->menu('fa-circle-info');
            ...
            if (count($menu_items) > 0) {
                ...
                <div class="col-ss-12 col-xs-6 col-sm-12 col-md-12">
                    <div class="border p-10 pl-20 pr-20 mb-20 bg-first">
                        <?php
                        echo Menu::widget(['items' => $menu_items,
                            'options' => [
                                'class' => 'list-unstyled',
                            ],
                            'linkActiveTemplate' => '<div class="fs-16 mt-10 lh-16"><b><a href="{url}">{label}</a></b></div>',
                            'linkTemplate' => '<div class="list-unstyled fs-16 mt-10 lh-16"><img src="{ico}" width="48" height="48">&nbsp<a href="{url}">{label}</a></div>',
